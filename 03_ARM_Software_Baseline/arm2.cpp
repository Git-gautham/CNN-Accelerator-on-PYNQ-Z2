...
int main()
{
    ...
    load_file("quantized_weights_files/conv1.weight.txt", c1_w);
    load_file("quantized_weights_files/conv1.bias.txt",   c1_b);
    load_file("quantized_weights_files/conv2.weight.txt", c2_w);
    load_file("quantized_weights_files/conv2.bias.txt",   c2_b);
    load_file("quantized_weights_files/conv3.weight.txt", c3_w);
    load_file("quantized_weights_files/conv3.bias.txt",   c3_b);
    load_file("quantized_weights_files/fc.weight.txt",    fc_w);
    load_file("quantized_weights_files/fc.bias.txt",      fc_b);

    ifstream file("cifar_test_100.txt");

    if(!file.is_open()) {
        cout << "ERROR opening cifar_test.txt" << endl;
        return 1;
    }
...
// Forward pass
    ...
    cout << "\nTotal images: " << total << endl;
    cout << "Correct: " << correct << endl;
    cout << "Accuracy: "
         << (float)correct / total * 100
         << " %" << endl;

    cout << "Total inference time: "
         << chrono::duration<double>(end_total - start_total).count()
         << " seconds" << endl;
